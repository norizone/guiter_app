...
export const InputArea = () => {
  ...
  const [selectedTuningIndex, setSelectedTuningIndex] =
    useRecoilState<number>(scaleSelectedTuning);
  const [selectedNoteKeyIndex, setSelectedNoteKeyIndex] =
    useRecoilState<number>(scaleSelectedKey);
  const [selectedScaleIndex, setSelectedScaleIndex] =
    useRecoilState<number>(scaleSelectedScale);
  ...
  return (
    <PrimaryInputsWrap areaType="input">
      <PrimarySelect
        title="Tuning"
        values={tunings}
        changeEvent={setSelectedTuningIndex}
        selectedIndex={selectedTuningIndex}
      />
      <PrimarySelect
        title="Key"
        values={noteKeys}
        changeEvent={setSelectedNoteKeyIndex}
        selectedIndex={selectedNoteKeyIndex}
      />
      <PrimarySelect
        title="Scale"
        values={scales}
        changeEvent={setSelectedScaleIndex}
